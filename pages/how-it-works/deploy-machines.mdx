...
The dedvpod agent starts a SSH server using the STDIO of the secure tunnel in order for you local Devsy CLI/UI to forward ports over the SSH connection. Once this is done Devsy starts your local
