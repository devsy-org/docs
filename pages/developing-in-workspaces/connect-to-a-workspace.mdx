...
If you have selected an IDE to automatically open, Devsy will automatically try to open the IDE after a successful workspace creation or `devsy up` command.
