...
<figure>
  <img src="/docs/media/create-workspace-ssh.png" alt="Devsy Flow" />
...
<figure>
  <img src="/docs/media/create-workspace-final-ssh.png" alt="Devsy Flow" />
  <figcaption>Create Workspace</figcaption>
</figure>

A new window appears showing Devsy starting the workspace. After the workspace was created, you can connect to the workspace via ssh:
