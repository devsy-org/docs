...
Make sure you have installed [Devsy](./install.mdx) on your system.
...
<figure>
<img src="/docs/media/create-workspace-repo.png" alt="Devsy Flow" />
...
<figure>
  <img src="/docs/media/create-workspace-jetbrains.png" alt="Devsy Flow" />
...
<figure>
  <img src="/docs/media/create-workspace-final-jetbrains.png" alt="Devsy Flow" />
  <figcaption>Create Workspace</figcaption>
</figure>

A new window appears showing Devsy starting the workspace. After the workspace was created, JetBrains Gateway should automatically open with a prefilled form for the workspace.
